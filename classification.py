...
path="E:\python practice\image\corn_yp"
model_path="E:\python practice\image\model\\"
#specification of picture
width=100
height=100
...
# -----------------构建网络----------------------
# cnn网络模型，共有7层，前三层为卷积层，后三层为全连接层，前三层中，每层包含卷积、激活、池化层
# 占位符设置输入参数的大小和格式
